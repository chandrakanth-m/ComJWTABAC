...
import com.example.springbootapp.model.auth.ERole;
import com.example.springbootapp.model.auth.Role;
import com.example.springbootapp.model.auth.User;
import com.example.springbootapp.payload.request.LoginRequest;
import com.example.springbootapp.payload.request.SignupRequest;
import com.example.springbootapp.payload.response.JwtResponse;
